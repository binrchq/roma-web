      ...
      >
        ...
        <div
          className={cn(
            ...
            "w-[var(--sidebar-width)]",
            // When collapsed as offcanvas, width is 0
            "group-data-[collapsible=offcanvas]:w-0",
            // When collapsed as icon, use icon width
...
const SidebarGroupLabel = React.forwardRef(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-13 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opacity] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
